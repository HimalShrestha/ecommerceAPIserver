...
router.get('/', function(req,res){
  ...
  db.pool.query(`SELECT * FROM paymentmethods ORDER BY PaymentID DESC `+limit).then(function(result){
    db.pool.query(`SELECT COUNT(*) FROM paymentmethods`).then(function(count){
